...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-main-merge/python/matchedfilter/metal/tc_corr_series2_131072.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-main-merge/python/matchedfilter/metal/tc_corr_series2_131072.slang"
    return;
}
...
#line 1237
        r_5[m_1] = float2(*((&kernelContext_4)->entryPointParams_scratch_0+(pair_0 * 131072U + _S27 * 256U + tid_1 + 16U * m_1))) ;
...
#line 1240
        uint lag_0 = slotToIndex_0(tid_1 * 16U + i_4) * 512U + _S27;
...
#line 1241
            *((&kernelContext_4)->entryPointParams_output_0+(_S28 * entryPointParams_1->params_0.y + _S29 + lag_0)) = packed_float2(float2(r_5[i_4].x, r_5[i_4].y)) ;
