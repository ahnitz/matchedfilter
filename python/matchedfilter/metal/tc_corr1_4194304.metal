...
#line 187 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_4194304.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_4194304.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_4194304.slang"
    return;
}
...
#line 1096
    uint pair_0 = _S41 / 2048U;

#line 1096
    uint _S42 = _S41 % 2048U;
...
#line 1104
        uint j_4 = _S42 + 2048U * (tid_1 + 128U * m_2);
        r_5[m_2] = cmulConj_0(float2(*((&kernelContext_4)->entryPointParams_data_0+(_S43 * 4194304U + j_4))) , float2(*((&kernelContext_4)->entryPointParams_tmpl_0+(_S44 * 4194304U + j_4))) );
...
#line 1113
        ...
        float a_3 = 6.28318548202514648 * float(_S42 * k2_2) / 4.194304e+06;

#line 1114
        *((&kernelContext_4)->entryPointParams_scratch_0+(pair_0 * 4194304U + k2_2 * 2048U + _S42)) = packed_float2(cmul_0(r_5[i_5], float2(cos(a_3), sin(a_3)))) ;
