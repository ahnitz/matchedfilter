...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-main-merge/python/matchedfilter/metal/tc_corr_series2_2097152.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-main-merge/python/matchedfilter/metal/tc_corr_series2_2097152.slang"
    return;
}
...
#line 1237
        r_5[m_2] = float2(*((&kernelContext_4)->entryPointParams_scratch_0+(pair_0 * 2097152U + _S36 * 1024U + tid_1 + 64U * m_2))) ;
...
#line 1240
        uint lag_0 = slotToIndex_0(tid_1 * 16U + i_4) * 2048U + _S36;
