...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_1048576.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_1048576.slang"
    return;
}
...
#line 1189
        r_5[m_2] = float2(*((&kernelContext_4)->entryPointParams_scratch_0+(_S36 * 1048576U + _S37 * 1024U + tid_1 + 64U * m_2))) ;
...
#line 1191
        *((&kernelContext_4)->entryPointParams_output_0+(_S36 * 1048576U + slotToIndex_0(tid_1 * 16U + i_4) * 1024U + _S37)) = packed_float2(float2(r_5[i_4].x, r_5[i_4].y)) ;
