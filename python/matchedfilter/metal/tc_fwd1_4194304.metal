...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_4194304.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_4194304.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_4194304.slang"
    return;
}
...
#line 1206
    uint block_0 = _S37 / 2048U;

#line 1206
    uint _S38 = _S37 % 2048U;
    uint tid_1 = lid_0.x;
    uint _S39 = entryPointParams_starts_1[block_0];
...
#line 1213
        uint j_4 = _S38 + 2048U * (tid_1 + 128U * m_2);
        float2 _S40 = float2(0.0, 0.0);

#line 1214
        bool _S41;
        if(_S39 < ((&kernelContext_4)->entryPointParams_0->seriesLength_0))
        {

#line 1215
            _S41 = j_4 < ((&kernelContext_4)->entryPointParams_0->seriesLength_0 - _S39);
...
#line 1215
            x_1 = float2(*((&kernelContext_4)->entryPointParams_series_0+(_S39 + j_4))) ;
...
#line 1215
        ...
        r_5[m_2] = float2(x_1.x / 4.194304e+06, - x_1.y / 4.194304e+06);
...
#line 1221
        ...
        float a_2 = 6.28318548202514648 * float(_S38 * k2_2) / 4.194304e+06;

#line 1222
        *((&kernelContext_4)->entryPointParams_scratch_0+(block_0 * 4194304U + k2_2 * 2048U + _S38)) = packed_float2(cmul_0(r_5[i_5], float2(cos(a_2), sin(a_2)))) ;
