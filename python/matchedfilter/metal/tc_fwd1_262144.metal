...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_262144.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_262144.slang"
...
#line 27
                float a1_0 = 6.28318548202514648 * float(lane_0) / 512.0;
                float _S16 = cos(a1_0);
...
#line 27
                float a1_1 = 6.28318548202514648 * float(lane_1) / 32.0;
                float _S26 = cos(a1_1);
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_262144.slang"
    return;
}
...
#line 1206
    uint block_0 = _S35 / 512U;

#line 1206
    uint _S36 = _S35 % 512U;
    uint tid_1 = lid_0.x;
    uint _S37 = entryPointParams_starts_1[block_0];
...
#line 1213
        uint j_3 = _S36 + 512U * (tid_1 + 32U * m_2);
        float2 _S38 = float2(0.0, 0.0);
...
#line 1215
            _S39 = j_3 < ((&kernelContext_4)->entryPointParams_0->seriesLength_0 - _S37);
...
#line 1215
            x_1 = float2(*((&kernelContext_4)->entryPointParams_series_0+(_S37 + j_3))) ;
...
#line 1215
        ...
        r_5[m_2] = float2(x_1.x / 2.62144e+05, - x_1.y / 2.62144e+05);
...
#line 1221
        ...
        float a_3 = 6.28318548202514648 * float(_S36 * k2_2) / 2.62144e+05;

#line 1222
        *((&kernelContext_4)->entryPointParams_scratch_0+(block_0 * 262144U + k2_2 * 512U + _S36)) = packed_float2(cmul_0(r_5[i_4], float2(cos(a_3), sin(a_3)))) ;
