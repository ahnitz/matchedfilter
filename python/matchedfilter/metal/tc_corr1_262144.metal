...
#line 187 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_262144.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_262144.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr1_262144.slang"
    return;
}
...
#line 1104
        uint j_3 = _S40 + 512U * (tid_1 + 32U * m_2);
        r_5[m_2] = cmulConj_0(float2(*((&kernelContext_4)->entryPointParams_data_0+(_S41 * 262144U + j_3))) , float2(*((&kernelContext_4)->entryPointParams_tmpl_0+(_S42 * 262144U + j_3))) );
...
#line 1113
        ...
        float a_4 = 6.28318548202514648 * float(_S40 * k2_2) / 2.62144e+05;

#line 1114
        *((&kernelContext_4)->entryPointParams_scratch_0+(pair_0 * 262144U + k2_2 * 512U + _S40)) = packed_float2(cmul_0(r_5[i_4], float2(cos(a_4), sin(a_4)))) ;
