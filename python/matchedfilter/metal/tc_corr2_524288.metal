...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_524288.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_524288.slang"
    return;
}
...
#line 1189
        r_5[m_2] = float2(*((&kernelContext_4)->entryPointParams_scratch_0+(_S36 * 524288U + _S37 * 512U + tid_1 + 32U * m_2))) ;
...
#line 1191
        *((&kernelContext_4)->entryPointParams_output_0+(_S36 * 524288U + slotToIndex_0(tid_1 * 16U + i_4) * 1024U + _S37)) = packed_float2(float2(r_5[i_4].x, r_5[i_4].y)) ;
