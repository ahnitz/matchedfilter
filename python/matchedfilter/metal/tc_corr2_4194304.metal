...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_4194304.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_corr2_4194304.slang"
    return;
}
...
#line 1189
        r_5[m_2] = float2(*((&kernelContext_4)->entryPointParams_scratch_0+(_S38 * 4194304U + _S39 * 2048U + tid_1 + 128U * m_2))) ;
...
#line 1191
        *((&kernelContext_4)->entryPointParams_output_0+(_S38 * 4194304U + slotToIndex_0(tid_1 * 16U + i_5) * 2048U + _S39)) = packed_float2(float2(r_5[i_5].x, r_5[i_5].y)) ;
