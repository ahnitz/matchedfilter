...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_2097152.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_2097152.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_2097152.slang"
    return;
}
...
#line 1206
    uint block_0 = _S37 / 1024U;

#line 1206
    uint _S38 = _S37 % 1024U;
    uint tid_1 = lid_0.x;
...
#line 1213
        uint j_4 = _S38 + 1024U * (tid_1 + 128U * m_2);
...
#line 1215
        ...
        r_5[m_2] = float2(x_1.x / 2.097152e+06, - x_1.y / 2.097152e+06);
...
#line 1221
        ...
        float a_2 = 6.28318548202514648 * float(_S38 * k2_2) / 2.097152e+06;

#line 1222
        *((&kernelContext_4)->entryPointParams_scratch_0+(block_0 * 2097152U + k2_2 * 1024U + _S38)) = packed_float2(cmul_0(r_5[i_5], float2(cos(a_2), sin(a_2)))) ;
