...
#line 336 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_1048576.slang"
...
#line 175 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_1048576.slang"
...
#line 582 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/tc_fwd1_1048576.slang"
    return;
}
...
#line 1213
        uint j_3 = _S36 + 1024U * (tid_1 + 64U * m_2);
...
#line 1215
            x_2 = float2(*((&kernelContext_4)->entryPointParams_series_0+(_S37 + j_3))) ;
...
#line 1215
        ...
        r_5[m_2] = float2(x_2.x / 1.048576e+06, - x_2.y / 1.048576e+06);
...
#line 1221
        ...
        float a_2 = 6.28318548202514648 * float(_S36 * k2_2) / 1.048576e+06;

#line 1222
        *((&kernelContext_4)->entryPointParams_scratch_0+(block_0 * 1048576U + k2_2 * 1024U + _S36)) = packed_float2(cmul_0(r_5[i_4], float2(cos(a_2), sin(a_2)))) ;
