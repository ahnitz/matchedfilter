...
#line 149 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/mm_8192_fullCorrelation_lds32.slang"
...
#line 177 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/mm_8192_fullCorrelation_lds32.slang"
...
#line 27
                float a1_0 = 6.28318548202514648 * float(lane_0) / 8192.0;
                float _S22 = cos(a1_0);
...
#line 27
                float a1_1 = 6.28318548202514648 * float(lane_1) / 512.0;
                float _S31 = cos(a1_1);
...
#line 27
                float a1_2 = 6.28318548202514648 * float(lane_2) / 32.0;
                float _S40 = cos(a1_2);
...
#line 584 "/home/ahnitz/projects/claude/searchdev/work/mf-full-corr/python/matchedfilter/metal/mm_8192_fullCorrelation_lds32.slang"
    return;
}
...
#line 984
    uint tid_1 = lid_0.x;
    uint _S49 = pair_0 / entryPointParams_1->ntmpl_0;

#line 985
    uint _S50 = pair_0 % entryPointParams_1->ntmpl_0;
...
#line 990
        ...
        r_5[i_5] = cmulConj_0(cload_0((&kernelContext_4)->entryPointParams_data_0, _S49 * 8192U + idx_0), cload_0((&kernelContext_4)->entryPointParams_tmpl_0, _S50 * 8192U + idx_0));
...
#line 994
        *((&kernelContext_4)->entryPointParams_output_0+(pair_0 * 8192U + slotToIndex_0(tid_1 * 16U + i_5))) = packed_float2(float2(r_5[i_5].x, r_5[i_5].y)) ;
